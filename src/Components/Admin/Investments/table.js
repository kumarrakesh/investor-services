...
const originalRows = [
  createData('21/01/2021', 'Axis Securities', 'Anil Jain', '$4.56', '$25.67','Withdraw'),
  createData('21/01/2021', 'Axis Securities', 'Anil Jain', '$4.56', '$25.67','Invest'),
  createData('21/01/2021', 'Axis Securities', 'Anil Jain', '$4.56', '$25.67','Withdraw'),
  createData('21/01/2021', 'Axis Securities', 'Anil Jain', '$4.56', '$25.67','Withdraw'),
  createData('21/01/2021', 'Axis Securities', 'Anil Jain', '$4.56', '$25.67','Invest'),
  createData('21/01/2021', 'Axis Securities', 'Anil Jain', '$4.56', '$25.67','Invest'),
        ...
        <TableBody>
          {rows.map((row) => (
             <StyledTableRow key={row.name}>
              ...
              <StyledTableCell align="center" component="th" scope="row">{row.FundName}</StyledTableCell>
              <StyledTableCell align="left" component="th" scope="row">{row.InvName}</StyledTableCell>
              <StyledTableCell align="center" component="th" scope="row">{row.NAV}</StyledTableCell>
              <StyledTableCell align="center" component="th" scope="row">{row.Amount}</StyledTableCell>
