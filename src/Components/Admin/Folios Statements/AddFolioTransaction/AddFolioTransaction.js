...
import './AddFolioTransaction.css';
  ...
  return (
    <div className="add-transaction-main">
      ...
      <div id="add-transaction-container">
        <div className="add-transaction-title">Folios Statements</div>
        ...
        <div className="add-investments-forms">
          <div>
            <FormControl variant="standard" sx={{ width: '100%' }}>
              ...
              <FormHelperText>Investor ID *</FormHelperText>
              <Select
          ...
          <div>
            <FormControl variant="standard" sx={{ width: '100%' }}>
              ...
              <FormHelperText>Folio ID *</FormHelperText>
              <Select
                value={formData.invName}
                name="invName"
                onChange={handleChangeFormData}
            ...
            <FormControl variant="standard" sx={{ width: '100%' }}>
              ...
              <FormHelperText>Folio Name *</FormHelperText>
              <Select
                name="fundname"
                variant="outlined"
                value={formData.fundname}
...
export default AddFolioTransaction;
