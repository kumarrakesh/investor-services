...
const rows = [
  createData('21/01/2021', 'Axis Securities', '#1012', '$25.67', '$10000.00','$10000.00'),
  createData('21/01/2021', 'Axis Securities', '#1012', '$25.67', '$10000.00','$10000.00'),
  createData('21/01/2021', 'Axis Securities', '#1012', '$25.67', '$10000.00','$10000.00'),
  createData('21/01/2021', 'Axis Securities', '#1012', '$25.67', '$10000.00','$10000.00'),
  createData('21/01/2021', 'Axis Securities', '#1012', '$25.67', '$10000.00','$10000.00'),
      ...
      <Table sx={{ minWidth: 700 ,height:"100px", overflow:"scroll"}} aria-label="customized table">
        <TableHead>
          <TableRow>
            ...
            <StyledTableCell align="center">Net Asset Value(NAV)</StyledTableCell>
            <StyledTableCell align="center">Invested Amount</StyledTableCell>
            <StyledTableCell align="center">Current Invested Value</StyledTableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {rows.map((row) => (
             <StyledTableRow key={row.name}>
              ...
              <StyledTableCell align="center" component="th" scope="row">{row.FundId}</StyledTableCell>
